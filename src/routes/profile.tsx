      ...
      <div className="mx-auto max-w-2xl space-y-6">
        <Card className="p-6">
          ...
          {me.mustChangePassword && (
            <p className="mt-4 rounded-md border border-amber-500/30 bg-amber-500/10 p-3 text-xs text-amber-700 dark:text-amber-400">
              Please change your password before continuing to use the system.
            </p>
          )}
        </Card>
